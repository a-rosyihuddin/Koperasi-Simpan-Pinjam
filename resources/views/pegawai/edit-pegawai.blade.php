                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body px-0 pt-0 pb-2">
                        <div class="table-responsive p-0">
                            <div class="card-body">
                                <form role="form" method="POST" action="{{ Route('pegawai.update', $pegawai->id) }}">
                                    @csrf
                                    @method('PUT')
                                    <div class="mb-3">
                                        <label for="nama_pegawai">Nama</label>
                                        <input type="text" class="form-control" placeholder="Nama Pegawai"
                                            aria-label="Nama Pegawai" name="nama_pegawai"
                                            value="{{ $pegawai->nama_pegawai }}" required autofocus>
                                    </div>
