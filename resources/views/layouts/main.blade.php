    ...
    <aside
        ...
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href="/" target="_blank">
                ...
                <span class="ms-1 font-weight-bold">KSP Citra Abadi</span>
            </a>
        </div>
        ...
        <div id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link @if ($title == 'Data Peminjam') active @endif"
                        href="{{ Route('peminjam.index') }}">
                        <div
                            class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="ni ni-collection text-info text-sm opacity-10"></i>
                        </div>
                        <span class="nav-link-text ms-1">Peminjam</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link @if ($title == 'Data Pegawai') active @endif"
    ...
    <div class="fixed-plugin">
        ...
        <div class="card shadow-lg">
            ...
            <div class="card-body pt-sm-3 pt-0 overflow-auto">
                ...
                <p class="text-sm d-xl-none d-block mt-2">Kamu bisa merubah sidebar tipe hanya di tampilan dekstop</p>
                <!-- Navbar Fixed -->
